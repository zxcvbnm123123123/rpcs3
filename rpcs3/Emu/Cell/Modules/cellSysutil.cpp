...
s32 _ZN4cxml8Document12RegisterFileEPKvjPNS_4FileE(vm::ptr<cxml_document> cxmlDoc, vm::cptr<char> name, s32 strlen, vm::ptr<cxml_attribute> attribute)
{
	cellSysutil.error("_ZN4cxml8Document12RegisterFileEPKvjPNS_4FileE(cxmlDoc=*0x%x, name=%s, strlen=0x%x, attribute=*0x%x)", cxmlDoc, name, strlen, attribute);
...
s32 _ZN8cxmlutil7SetFileERKN4cxml7ElementEPKcRKNS0_4FileE(vm::ptr<cxml_element> element, vm::cptr<char> name, vm::ptr<cxml_attribute> attribute)
{
	cellSysutil.error("_ZN8cxmlutil7SetFileERKN4cxml7ElementEPKcRKNS0_4FileE(element=*0x%x, name=%s, attribute=*0x%x)", element, name, attribute);
...
s32 ZN4cxml8Document5WriteEPFiPKvjPvES3(ppu_thread& ppu, vm::ptr<cxml_document> cxmlDoc, vm::ptr<CXmlReAlloc> funcptr, vm::ptr<SysutilPacketInfo> packetInfo)
{
	cellSysutil.error("ZN4cxml8Document5WriteEPFiPKvjPvES3(cxmlDoc=*0x%x, funcptr=*0x%x, packetInfo=*0x%x)", cxmlDoc, funcptr, packetInfo);
